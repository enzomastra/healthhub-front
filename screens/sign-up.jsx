      ...
      <ScrollView>
        <View className="w-full justify-center min-h-[82vh] px-4 my-6">
          ...
          <FormField
            ...
            value={form.weight}
            handleChangeText={(text) => setForm({ ...form, weight: text })}
          />
          ...
          <FormField
            ...
            value={form.height}
            handleChangeText={(text) => setForm({ ...form, height: text })}
          />
          ...
          <View className="justify-center flex-row pt-5 gap-2">
            ...
            <Link href="/sign-in" className='text-lg font-semibold text-secondary-bridge'> Sign In </Link>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
